...
* @license MIT
*/
define(["jquery", "qvangular", "text!./eui-simple-table.ng.html", "text!./eui-simple-table.css"], function($, qvangular, ngTemplate, cssContent) {
    "use strict";
    ...
    addStyleToHeader(cssContent, "eui-simple-table"), qvangular.directive("euiSimpleTable", [function() {
        return {
            restrict: "EA",
            scope: {
                hyperCube: "="
